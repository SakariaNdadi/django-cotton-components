...
urlpatterns = [
    ...
    path("pages/", PageIndex.as_view(), name="pages"),
    path("pages/<int:pk>/", PageBuilder.as_view(), name="page"),
    path("pages/<int:pk>/save/", PageSave.as_view(), name="page-save"),
    path("pages/<int:pk>/preview/", PagePreview.as_view(), name="page-preview"),
