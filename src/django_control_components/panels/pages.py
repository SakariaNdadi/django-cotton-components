...
class ListRecords(TableMixin, _ResourcePage):
    template_name = "django_control_components/panels/list.html"
    action = "view"
...
class _FormPage(_ResourcePage):
    template_name = "django_control_components/panels/form.html"
...
class ViewRecord(_ResourcePage):
    template_name = "django_control_components/panels/view.html"
    action = "view"
...
class DeleteRecord(_ResourcePage):
    template_name = "django_control_components/panels/delete.html"
    action = "delete"
