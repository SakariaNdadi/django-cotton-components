...
class DjangoCottonComponentsConfig(AppConfig):
    ...
    verbose_name = "Django Cotton Components"
    ...
    if not apps.is_installed("django_cotton"):
        errors.append(
            Error(
                ...
                hint="Add 'django_cotton' to INSTALLED_APPS before 'django_cotton_components'.",
                id="django_cotton_components.E001",
            )
        )
    ...
    if not has_django_backend:
        errors.append(
            Warning(
                ...
                id="django_cotton_components.W002",
            )
        )
