...
Enable with ``pip install "django-cotton-components[allauth]"`` and, in settings::

    ACCOUNT_ADAPTER = "django_cotton_components.integrations.allauth.DCCAccountAdapter"
...
try:
    ...
    raise ImproperlyConfigured(
        'django-allauth is not installed. Run: pip install "django-cotton-components[allauth]"'
    ) from exc
