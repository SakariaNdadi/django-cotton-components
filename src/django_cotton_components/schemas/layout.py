...
class Section(Layout):
    template_name = "django_cotton_components/layout/section.html"
...
class Grid(Layout):
    template_name = "django_cotton_components/layout/grid.html"
...
class Fieldset(Layout):
    template_name = "django_cotton_components/layout/fieldset.html"
...
class Tabs(Layout):
    template_name = "django_cotton_components/layout/tabs.html"
